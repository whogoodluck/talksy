...
function NavigationLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <main className='flex h-screen'>
      <div className='md:bg-foreground/5 bg-background fixed bottom-0 flex w-full items-center gap-6 px-2 md:relative md:h-full md:w-16 md:flex-col md:gap-2 md:border-r md:px-1 md:py-4'>

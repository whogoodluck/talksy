...
function MessageInput() {
  ...
  return (
    <form
      ...
      className={cn('bg-background flex items-end rounded-full border px-4 py-[6px] shadow-sm')}
    >
      ...
      <Textarea
        ...
        className={cn(
          'bg-background my-auto mr-1 max-h-[150px] resize-none border-none pl-1 break-words whitespace-pre-wrap',

...
import { verifyResetCodeSchema, type VerifyResetCodeRequest } from '@/schemas/user.schema'
...
function VerifyResetCode() {
  ...
  const form = useForm<VerifyResetCodeRequest>({
  ...
  const onSubmit = (values: VerifyResetCodeRequest) => {
    verifyResetCode.mutate(values)
  }
        ...
        <div className='text-muted-foreground space-y-2 text-center text-sm'>
          ...
          <div>
            <Link
              ...
              className='text-secondary inline-flex items-center gap-1 font-medium underline-offset-4 hover:underline active:underline'
            >
